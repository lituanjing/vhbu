...
const CategorySection = styled.section`
  ...
  > ul {
    display: flex;
    background: #c4c4c4;
    > li { width: 50%; text-align: center; padding: 16px 0;
      position: relative;
      &.selected:after { content: ''; display: block; height: 3px;
        width: 100%; background: #333; position: absolute; bottom: 0;
        left: 0; }
    }
  }
`;
...
const NumberPadSection = styled.section`
  ...
  > .output { background: #fff; font-size: 36px; line-height: 72px; text-align: right;
   padding: 0 16px;
   box-shadow: inset 0 -5px 5px -5px rgba(0, 0, 0, .25),
   inset 0 5px 5px -5px rgba(0, 0, 0, .25); }
  > .pad {
    > button { float: left; width: 25%; height: 64px; font-size: 18px;
      border: none;
